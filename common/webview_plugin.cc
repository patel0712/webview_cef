...
namespace webview_cef
{
	...
	// webview_plugin.cc
	void WebviewPlugin::setInvokeMethodFuncWithReturnVal(std::function<WValue *(std::string, WValue *)> func)
	{
		std::cout << "[webview_plugin.cc] Setting m_invokeFuncReturnVal" << std::endl;
		m_invokeFuncReturnVal = func;
	}
